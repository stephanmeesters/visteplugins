/*=========================================================================
  ...
  Module:    vtkCurvaturesShapeIndex.h
...
=========================================================================*/
// .NAME vtkCurvaturesShapeIndex - compute curvatures (Gauss and mean) of a Polydata object
// .SECTION Description
// vtkCurvaturesShapeIndex takes a polydata input and computes the curvature of the
...
#ifndef __vtkCurvaturesShapeIndex_h
#define __vtkCurvaturesShapeIndex_h
...
#define VTK_SHAPE_INDEX 4
#define VTK_CURVEDNESS 5

class vtkCurvaturesShapeIndex : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(vtkCurvaturesShapeIndex,vtkPolyDataAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Construct with curvature type set to Gauss
  static vtkCurvaturesShapeIndex *New();
  ...
  void SetCurvatureTypeToShapeIndex()
  { this->SetCurvatureType(VTK_SHAPE_INDEX); }
  void SetCurvatureTypeToCurvedness()
  { this->SetCurvatureType(VTK_CURVEDNESS); }
...
protected:
  ...
  //Description:
  // Stephan Meesters 12-5-2013
  // Shape index 2/pi arctan ( (k1 + k2)/(k1-k2) )
  void GetShapeIndex(vtkPolyData *input, vtkPolyData *output);

    //Description:
  // Stephan Meesters 12-5-2013
  // Shape index 2/pi arctan ( (k1 + k2)/(k1-k2) )
  void GetCurvedness(vtkPolyData *input, vtkPolyData *output);
...
private:
  vtkCurvaturesShapeIndex(const vtkCurvaturesShapeIndex&);  // Not implemented.
  void operator=(const vtkCurvaturesShapeIndex&);  // Not implemented.
